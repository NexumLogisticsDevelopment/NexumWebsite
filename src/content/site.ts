...
export const CASE_STUDIES: CaseStudy[] = [
  {
    photo: IMAGES.serviceSencillo,
    photoAlt: 'Contenedores en ruta',
    tag: 'Carga contenerizada',
    title: 'Reubicación de contenedores 40’',
    text: 'Coordinación de salidas semanales de contenedores secos hacia el Bajío para un importador de insumos industriales.',
    route: 'Manzanillo → Guadalajara / Bajío',
  },
  {
    photo: IMAGES.serviceLowboy,
  ...
  {
    photo: IMAGES.stripPortDusk,
    photoAlt: 'Patio de contenedores del puerto',
    tag: 'Bolsas y big bags',
    title: 'Distribución de insumos a granel',
    text: 'Distribución periódica de insumos a granel para una planta de proceso en el norte del país.',
    route: 'Manzanillo → Monterrey',
  },
  {
    photo: IMAGES.processBand,
    photoAlt: 'Terminal de carga en movimiento',
    tag: 'Rollos',
  ...
  {
    photo: IMAGES.serviceFull,
    photoAlt: 'Doble remolque en carretera',
    tag: 'Doble remolque',
    title: 'Operación de alto volumen',
    text: 'Cobertura de un incremento estacional de demanda con unidades de doble remolque y seguimiento constante.',
    route: 'Manzanillo → Saltillo',
  },
];
...
export const SERVICES: ServiceItem[] = [
  {
    ...
    icon: 'truck-field',
    title: 'Full',
    text: 'Transporte de doble remolque para operaciones de alto volumen y máxima eficiencia.',
  },
  {
    photo: IMAGES.serviceSencillo,
    tag: 'CARGA CONTENERIZADA',
    icon: 'truck',
    title: 'Sencillo',
    text: 'Soluciones flexibles para movimientos nacionales de carga contenerizada.',
  },
  {
    photo: IMAGES.serviceCamioneta,
    tag: 'DISTRIBUCIÓN ÁGIL',
    icon: 'truck-ramp-box',
    title: 'Camioneta 3.5 Tons',
    text: 'Distribución urbana y regional para entregas ágiles y seguras.',
  },
  {
    photo: IMAGES.serviceLowboy,
    tag: 'CARGA ESPECIALIZADA',
    icon: 'truck-monster',
    title: 'Lowboy',
    text: 'Transporte especializado para maquinaria y carga sobredimensionada.',
  },
];
